...
export const Ws6Selectors = {
    getNomadPiglets: state => state.ws6.incomingPigletsList,
    getSections: state => state.ws6.incomingPigletsList,
    getIncomeTabLocations: state => state.ws6.incomeTabLocations,
    settlePiglets: state => state.ws6.setlledPiglets,
    getTransferPiglets: state => state.ws6.transferPiglets,
    getInnerTransferTabLocations1: state => state.ws6.innerTransferLocations1,
    getInnerTransferTabLocations2: state => state.ws6.innerTransferLocations2,
    weighingPiglets: state => state.ws6.weighingData,
}
